...
public class VmStateHistoryEntry {
	...
	public VmStateHistoryEntry(
		...
		setAllocatedRam(allocatedRam);
		setRequestedRam(requestedRam);
	}
	/**
	 * Sets the time.
	 * 
	...
	/**
	 * @param allocatedRam the allocatedRam to set
	 */
	protected void setAllocatedRam(int allocatedRam) {
		this.allocatedRam = allocatedRam;
	}

	/**
	 * @return the allocatedRam
	 */
	...
	/**
	 * @param requestedRam the requestedRam to set
	 */
	protected void setRequestedRam(int requestedRam) {
		this.requestedRam = requestedRam;
	}

	/**
	 * @return the requestedRam
	 */
