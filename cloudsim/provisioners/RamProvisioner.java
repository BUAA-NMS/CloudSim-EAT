 ...
 * 
 * 当扩展这个类时，必须当心availableMemory总是包括了 未来可allocations的内存数目
 * 
...
public abstract class RamProvisioner {
	 ...
	 * 尝试给指定的VM allocate RAM，成功则返回true
	 * 
	...
	/**
	 * Releases RAM used by a all VMs.
	 * 释放所有的VM占用的虚拟机资源，实际上就是AvailableRam重置为Ram
	 * 
	 * @pre $none
	 * @post none
	 */
