...
//		System.out.println();
//		System.out.println(getVmScheduler().getPeCapacity()+" "+ vm.getCurrentRequestedMaxMips());
//		System.out.println(getVmScheduler().getAvailableMips()+" "+ vm.getCurrentRequestedMaxMips());
//		System.out.println(getRamProvisioner().getAvailableRam() + " " + vm.getCurrentRequestedRam());
		if (Constants.LIMIT_VM_NUM)
		{
			if (vmList.size()<Constants.HOST_VM_MAX_NUM)
			{
	...
	public int getAllocatedRamForVm(Vm vm) {
		return getRamProvisioner().getAllocatedRamForVm(vm);
	}
	/**
