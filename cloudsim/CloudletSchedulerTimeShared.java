...
//	public double getCurrentRequestedUtilizationOfRam(double time) {
//		double ram = 0;
//		for (ResCloudlet cloudlet : cloudletExecList) {
//			ram += cloudlet.getCloudlet().getUtilizationOfRam(time);
//		}
//		return ram;
//	}
//
//	public double getCurrentRequestedUtilizationOfBw(double time) {
//		double bw = 0;
//		for (ResCloudlet cloudlet : cloudletExecList) {
//			bw += cloudlet.getCloudlet().getUtilizationOfBw(time);
//		}
//		return bw;
//	}
