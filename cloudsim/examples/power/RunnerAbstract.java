...
//import org.cloudbus.cloudsim.power.PowerVmAllocationPolicyMigrationBestFitPower;
//import org.cloudbus.cloudsim.power.PowerVmAllocationPolicyMigrationBestFitResource;
//import org.cloudbus.cloudsim.power.PowerVmAllocationPolicyMigrationFirstFitResource;
...
public abstract class RunnerAbstract {
	...
	protected String getExperimentName(String... args) {
		...
		experimentName.append("_");
		experimentName.append(Constants.Order);
...
//		else if (vmAllocationPolicyName.equals("FirstFitResource")) {
//			PowerVmAllocationPolicyMigrationAbstract fallbackVmSelectionPolicy = new PowerVmAllocationPolicyMigrationStaticThreshold(
//					hostList,
//					vmSelectionPolicy,
//					0.7);			
//			vmAllocationPolicy = new PowerVmAllocationPolicyMigrationFirstFitResource(
//					hostList,
//					vmSelectionPolicy,
//					parameter,
//					Constants.SCHEDULING_INTERVAL,
//					fallbackVmSelectionPolicy);
//		} else if (vmAllocationPolicyName.equals("BestFitResource")) {
//			PowerVmAllocationPolicyMigrationAbstract fallbackVmSelectionPolicy = new PowerVmAllocationPolicyMigrationStaticThreshold(
//					hostList,
//					vmSelectionPolicy,
//					0.7);			
//			vmAllocationPolicy = new PowerVmAllocationPolicyMigrationBestFitResource(
//					hostList,
//					vmSelectionPolicy,
//					parameter,
//					Constants.SCHEDULING_INTERVAL,
//					fallbackVmSelectionPolicy);
//		} else if (vmAllocationPolicyName.equals("BestFitPower")) {
//			PowerVmAllocationPolicyMigrationAbstract fallbackVmSelectionPolicy = new PowerVmAllocationPolicyMigrationStaticThreshold(
//					hostList,
//					vmSelectionPolicy,
//					0.7);
//			vmAllocationPolicy = new PowerVmAllocationPolicyMigrationBestFitPower(
//					hostList,
//					vmSelectionPolicy,
//					parameter,
//					Constants.SCHEDULING_INTERVAL,
