 ...
 * ResCloudlt表示了一个Cloudlet的处理过程。他纪录了一个特定的Cloudlet在资源池中的特定活动。
 * 他存储了一个分配列表，表示了分配给该任务的machine和pe
 * 
...
public class ResCloudlet {
	...
	/** The length of Cloudlet finished so far. 已经完成的长度，单位是Instructions*/
	...
	/** The index of machine and Pe arrays. 用于machine和Pe数组的下标*/
	private int index;
